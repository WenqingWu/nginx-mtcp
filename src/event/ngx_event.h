...
//#ifdef NGX_MTCP
/* mTCP hasn't support eventfd() wrapper */
...
/*     FLAG        */
#define NGX_READ_EVENT     (MTCP_EPOLLIN|MTCP_EPOLLRDHUP)
#define NGX_WRITE_EVENT    MTCP_EPOLLOUT

#define NGX_LEVEL_EVENT    0
#define NGX_CLEAR_EVENT    MTCP_EPOLLET
